...
export default class MaplibreExportControl implements IControl {
  ...
  public onAdd(map: MaplibreMap): HTMLElement {
    ...
    const tr2 = this.createSelection(PageOrientation, this.getTranslation().PageOrientation, 'page-orientation', this.options.PageOrientation, (data, key) => data[key]);
    ...
    generateButton.addEventListener('click', () => {
      ...
      const pageOrientation: HTMLSelectElement = <HTMLSelectElement>document.getElementById('mapbox-gl-export-page-orientation');
